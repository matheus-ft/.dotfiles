def onedark():
    return [
        ...
        ["#6c717a", "#6c717a"],  # light grey [1]
        ["#e6e6e6", "#e6e6e6"],  # forground (white) [2]
        ["#abb2bf", "#abb2bf"],  # blue/grey) [3]
        ["#56b6c2", "#56b6c2"],  # cyan [4]
        ["#98c379", "#98c379"],  # green [5]
        ["#d19a66", "#d19a66"],  # orange [6]
        ["#c678dd", "#c678dd"],  # pink [7]
        ["#5c79d1", "#5c79d1"],  # purple [8]
        ["#be5046", "#be5046"],  # red [9]
        ["#e5c07b", "#e5c07b"],  # yellow [10]
    ]
